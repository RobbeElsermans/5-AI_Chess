...
class TomUtility(Utility):
    ...
    def board_value(self, board: chess.Board):
        ...
        n_white += self.check_material_balance(board, chess.WHITE)
        n_white += self.check_center_control(board, chess.WHITE)
        n_white += self.check_piece_activity(board, chess.WHITE)
        n_white += self.check_capturable_pieces(board, chess.WHITE)

        n_black += self.check_material_balance(board, chess.BLACK)
        n_black += self.check_center_control(board, chess.BLACK)
        n_black += self.check_piece_activity(board, chess.BLACK)
        n_black += self.check_capturable_pieces(board, chess.BLACK)
