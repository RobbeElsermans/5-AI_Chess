...
def play_stockfish():
    ...
    black_player = chess.engine.SimpleEngine.popen_uci("/Home/Documents/school/semester_3/5_Artificiele_Intelligentie/lab/stockfish/stockfish-ubuntu-x86-64-avx2")
